...
`registry.codeocean.com/published/9704b887-df84-48a7-8b80-db56d627cc87:v1`
...
docker run --platform linux/amd64 --rm \
  ...
  registry.codeocean.com/published/9704b887-df84-48a7-8b80-db56d627cc87:v1 bash run
```
